        ...
        <div className='flex flex-col w-full md:w-1/2 p-10'>
          ...
          <form ref={form} onSubmit={sendEmail} className='flex flex-col space-y-4 py-10'>
            <div className='flex flex-col'>
              ...
              <input type="text" id='name' name="user_name" className='p-2 rounded-md text-black' />
            </div>
            <div className='flex flex-col'>
              <label htmlFor='email' className='text-xl'>Email</label>
              <input type="email" id='email' name="user_email" className='p-2 rounded-md text-black' />
            </div>
            <div className='flex flex-col'>
              <label htmlFor='message' className='text-xl'>Message</label>
              <textarea id='message' name="message" className='p-2 rounded-md h-[130px] text-black' />
            </div>
